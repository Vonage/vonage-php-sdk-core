...
=======
     * @param array|Call $payload New data for the call or the updated Call object
...
=======
        trigger_error(
            'Passing an array payload and call ID is being deprecated, please pass a Call object as the payload',
            E_USER_DEPRECATED
        );
>>>>>>> Allow Call to be passed as a payload to Call client::update()
